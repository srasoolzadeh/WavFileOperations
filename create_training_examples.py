...
def create_training_example(background, activates, negatives, index):
    ...
    filename = "training" +str(int(index))+ ".wav"
    ...
    return x, y
t1=np.zeros((2,101,5511), dtype='float64')
...
x , y = create_training_example(backgrounds[0], activates, negatives, 0)
t1[0]= x

t2=np.zeros((101, 5511))
np.append(t2, x)
    
for i in range(2):
    x , y = create_training_example(backgrounds[0], activates, negatives, i+1)
    t1[i]= x
